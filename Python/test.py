...
def run_network(duration, update=False, drive=0, timestep=1e-2):
    ...
    # drive = [3 + i/(n_iterations-1) for i in range(n_iterations)]
    ...
    print("Coupling weights: ", network.robot_parameters.coupling_weights)
    # print("amplitud_rates: ", network.robot_parameters.amplitudes_rate)
    # print("nominal_ampli: ",network.robot_parameters.nominal_amplitudes)
    # print("phase_bias: ",network.robot_parameters.phase_bias)
